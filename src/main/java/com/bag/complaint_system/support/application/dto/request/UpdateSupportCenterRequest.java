...
public class UpdateSupportCenterRequest {
  @Schema(
      description = "Updated official name of the center",
      example = "Casa Refugio Miraflores Modificado",
      minLength = 3,
      maxLength = 200)
  ...
  @Schema(
      description = "Updated physical street address",
      example = "Avenida Larco 789",
      maxLength = 300)
  ...
  @Schema(
      description = "Updated district location (within supported areas)",
      example = "MIRAFLORES")
  @NotNull(message = "The field District cannot be null.")
  private String district;

  @Schema(
      description = "Updated primary contact phone number",
      example = "+51988456456",
      minLength = 9,
      maxLength = 15)
  ...
  @Schema(
      description = "Updated administrative contact email",
      example = "new.contact@refugio.org",
      maxLength = 150)
  ...
  @Schema(
      description = "Updated operating hours and availability description",
      example = "Monday to Saturday, 08:00 - 20:00",
      maxLength = 200)
